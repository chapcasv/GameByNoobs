...
namespace EasyUI.Helpers
{
    ...
    public class ProgressUI : MonoBehaviour
    {
        ...
        [SerializeField] private GameObject uiLabel;
        ...
        [SerializeField] private SettingsProgressUI settings;
        ...
        private void SetLabel(bool enabled)
        {
            uiLabel.SetActive(enabled);
        }
